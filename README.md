...
4. Now take "cleantranslated.py" and go to https://www.ebi.ac.uk/jdispatcher/ for running Multiple Sequence Alignment using MUSCLE which uses ClustalW in a more precise manner. This will give an alignment file in ".fa" format and a phylogenetic tree which can be downloaded and viewed in the web viewer. Save these files in "04-Alignment Data". 
